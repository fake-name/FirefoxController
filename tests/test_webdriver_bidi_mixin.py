...
def interface():
    """Create a FirefoxRemoteDebugInterface with a mock manager to avoid starting Firefox.

    Tests that only inspect method availability, signatures, and backward
    compatibility don't need a live browser — they just need the interface
    object with all its methods present.
    """
    mock_manager = Mock(spec=FirefoxExecutionManager)
    mock_manager.browsing_context = "mock_context"
    iface = FirefoxRemoteDebugInterface(manager=mock_manager)
    yield iface
...
class TestWebDriverBiDiMixinIntegration:
    ...
    def test_interface_instantiation(self):
        """Test that FirefoxRemoteDebugInterface can be instantiated with a mock manager"""
        mock_manager = Mock(spec=FirefoxExecutionManager)
        mock_manager.browsing_context = "test_context"
        interface = FirefoxRemoteDebugInterface(manager=mock_manager)
...
class TestWebDriverBiDiMethodAvailability:
    ...
    def test_browsing_context_methods(self, interface):
    ...
    def test_script_methods(self, interface):
    ...
    def test_network_methods(self, interface):
    ...
    def test_storage_methods(self, interface):
    ...
    def test_session_methods(self, interface):
    ...
    def test_browser_methods(self, interface):
    ...
    def test_input_methods(self, interface):
...
class TestWebDriverBiDiMethodSignatures:
    ...
    def test_bidi_navigate_signature(self, interface):
    ...
    def test_bidi_evaluate_script_signature(self, interface):
    ...
    def test_bidi_capture_screenshot_signature(self, interface):
    ...
    def test_bidi_add_intercept_signature(self, interface):
...
class TestWebDriverBiDiMethodBehavior:
    ...
    def setup_method(self):
        ...
        mock_manager = Mock(spec=FirefoxExecutionManager)
        mock_manager.browsing_context = "test_context"
        self.interface = FirefoxRemoteDebugInterface(manager=mock_manager)
...
class TestWebDriverBiDiBackwardCompatibility:
    ...
    def test_original_methods_still_available(self, interface):
    ...
    def test_context_manager_interface_unchanged(self, interface):
...
class TestWebDriverBiDiMethodCount:
    ...
    def test_total_webdriver_bidi_methods(self, interface):
